  ...
  return (
    <div
      ...
      <div className="flex flex-col gap-3">
        <p className="font-bold uppercase opacity-[0.5] tracking-[1.75px] ">
          IP ADDRESS
        </p>
        <h2 className="font-bold text-[26px]">192.212.174.101</h2>
      </div>

      <div className=" w-[1px] h-[75px] bg-black opacity-[0.15]"></div>
      <div className="flex flex-col gap-3">
        <p className="font-bold uppercase opacity-[0.5] tracking-[1.75px] ">
          Location
        </p>
        <h2 className="font-bold text-[26px]">Brooklyn, NY 10001</h2>
      </div>
